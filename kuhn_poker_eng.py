...
import math
import random
from HU_Kuhn import HeadsUpPokerGame
import numpy as np
...
class PokerEnv(gym.Env):
    ...
    def get_state(self):
        return [self.action_player.card_1, self.game.pot_size,
    ...
    def step(self, action):
        ...
        self.state = [self.action_player.card_1, self.game.pot_size,
                      self.action_player.stack_size, self.inaction_player.stack_size]
        self.last_action = action
        return self.reward, self.done, [self.action_player.card_1, self.game.pot_size,
                                   self.action_player.stack_size, self.inaction_player.stack_size]
